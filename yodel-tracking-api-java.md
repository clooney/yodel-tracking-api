Yodel Tracking API - Java
================================
Use Java to track Yodel shipments with Yodel Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.yodel;
    ...
    public class CreateYodelTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("JD0002232555478643");
                createTrackingParams.setCourierCode("yodel");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateYodelTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("JJD0002232686018719");
                createTrackingParams1.setCourierCode("yodel");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("JJD0002232531035135");
                createTrackingParams2.setCourierCode("yodel");
...
Get status of the shipment:
    ...
    public class GetYodelTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("JJD0002232686018719,JJD0002232531035135");
                trackingParams.setCourierCode("yodel");
...
Update a tracking by ID:
    ...
    public class UpdateYodelTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "9bc1a1e12f6abba504b7a86e0f12886c";
