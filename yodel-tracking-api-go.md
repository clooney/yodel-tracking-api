Yodel Tracking API - Go
================================
Use Go to track Yodel shipments with Yodel Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    func main() {
      ...
      params := trackingmore.CreateTrackingParams{
        TrackingNumber: "JD0002232555478643",
        CourierCode:    "yodel",
      }      
...
Update a tracking by ID:
    ...
    func main() {
      ...
      idString := "9bc1a1e12f6abba504b7a86e0f12886c"
