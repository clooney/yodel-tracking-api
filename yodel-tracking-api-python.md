Yodel Tracking API - Python
================================
Use Python to track Yodel shipments with Yodel Tracking API.
...
Get status of the shipment:
    ...
    try:
      ...
      # params = {'tracking_numbers': 'JJD0002232531035135,JJD0002232531035135', 'courier_code': 'yodel'}
