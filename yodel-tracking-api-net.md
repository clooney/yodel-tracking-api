Yodel Tracking API - .Net
================================
Use .Net to track Yodel shipments with Yodel Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "JD0002232555478643";
                  createTrackingParams.courierCode = "yodel";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  {
                      trackingNumber = "JJD0002232686018719",
                      courierCode = "yodel"
                  };
                  ...
                  {
                      trackingNumber = "JJD0002232531035135",
                      courierCode = "yodel"
                  };
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "JJD0002232686018719,JJD0002232531035135";
                  getTrackingResultsParams.courierCode = "yodel";
